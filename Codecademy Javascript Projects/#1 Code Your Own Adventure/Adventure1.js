...
if(age < 13)
    {
        document.write("You can play but you have all the responsibility for your experience");
    }
else
    {
        document.write("Abandon all, ye who enter here...");
    };
...
var feedback = prompt("What do you think of the game, from 1 to 10, worst to greatest?")
